...
@section('body')
    <div style="color: white; display: flex;justify-content: center;">
        ...
        <table class="table table-dark table-hover;" style="width: 60%" >
            <thead>
              <tr>
                <th style="width: 40%" scope="col">@lang('index.action.action')</th>
                <th style="width: 60%"scope="col">@lang('index.book.title')</th>
              </tr>
            </thead>
            <tbody>
                @foreach ($books as $book )
                    <tr>
                        <td>{{$book->author}}</td>
                        <td><a href="/book/detail/{{$book->ebook_id}}">{{$book->title}}</a></td>
                    </tr>
                @endforeach
            </tbody>
          </table>
